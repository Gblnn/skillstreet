...
<div className='skillbee' style={{position:"absolute"}} id='skillbee'></div>

<div className='page' style={{marginTop:"35%",height:"fit-content", border:"", flexFlow:"column", marginBottom:"6rem"}}>
  ...
  style={{zIndex:1,width:"100%", border:"", display:'flex', alignItems:"center", flexFlow:"column"}}>
    ...
    <div style={{height:"15rem", border:"", width:"75%", marginTop:"1.5rem", display:"flex", alignItems:"center", flexFlow:"column"}}>
      ...
      <a href='#access'><button style={{marginTop:"4rem", zIndex:10}} className='btn'>Join <b>BETA</b></button></a>
...
{/* <div className='page' style={{border:"", height:"fit-content", paddingTop:"1rem", paddingBlock:"1rem", flexFlow:"column", marginTop:"10rem"}}>
